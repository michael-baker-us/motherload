...
export const BIOMES: readonly Biome[] = [
  { name: "Topsoil", minDepth: 0, fog: [8, 4, 2], tint: "#7a5a30", tintAlpha: 0, rumble: 0.5 },
  { name: "The Caverns", minDepth: 60, fog: [5, 7, 10], tint: "#3a4a5a", tintAlpha: 0.05, rumble: 1.0 },
  { name: "Magma Depths", minDepth: 250, fog: [20, 5, 3], tint: "#7a2412", tintAlpha: 0.08, rumble: 1.4 },
  { name: "The Deep", minDepth: 700, fog: [4, 6, 18], tint: "#1e2a7a", tintAlpha: 0.09, rumble: 1.1 },
];
